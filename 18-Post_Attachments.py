...
# URL בסיסי לשרת B
base_url_B = "http://192.168.1.91/DefaultCollection/DG-Dev/_apis"
    ...
    try:
        with open(json_file_path, 'r', encoding='utf-8') as json_file:
            ...
            for item in data:
                ...
                # תנאי: רק אם ה-ID גדול מ-100,000
                if work_item_id and work_item_id > 0:
                    ...
                    print(f"Skipping Work Item ID: {work_item_id} (ID is not > 100,000)")
...
# קריאה לפונקציה
json_path = "attachments.json"  # נתיב קובץ JSON
